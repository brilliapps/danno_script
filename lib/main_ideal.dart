...
class User {
  ...
  @$(num, String, Null, UserTypeOne(UserTypeOne(UserTypeOne(12))),
      UserTypeOne(10), $NOT, 5.3, 11, 10, someUserTypeOne, someInt, someDouble)
  methodOne4Simple(
  ...
  // Let this one will be for expressions and record "Type" and "Record instance"
  // Whether a Record is like-"Type" depends on place, f.e. return valule of a method - return Type or variable declaration
  // So in $() we must distinguish it "manually" - see problem because it will be always instance but we'll look how to inject f.e. a method declaration to the @$() instance.
  @$(num, String, Null, UserTypeOne(), $NOT, 5.3, 11, 10, someUserTypeOne,
      someInt, someDouble)
  methodOne4(
          [@$(num, String, Null, $NOT, int, 5.3) abcd = someInt ??
              someInt ??
      ...
      (someInt == 15
          ? switch (someUserType) {
              UserTypeOne() => 4.5,
              UserTypeTwo() => 'Other String',
              UserTypeTwo() => null
            }
          : /* FunctionExpression won't allow @$() here*/ (int a) {
              if (a == 10) {
                return <num, String>{};
              } else if (a == 20) {
                return null;
  ...
  methodOne2(
      ...
      anotherMethodParam == 20.4 ? 10 : 20.5;
}
...
void main() {
  ...
  jack.methodOne2(abc); // valid - blue underscore
  jack.methodOne2(UserTypeOne()); // valid - blue underscore
  abc = 'Example text3';
  ExampleAAA().a = 20;

  @$(String)
  const String abc2 = 'abc ${a} abc';
  List<Map<int, int>> ertret = [];
  List<Map<int, String>> ertret2 = [];
  const List<dynamic> ertret3 = ['String example', 12];
  // not const List... and cannot be const ['String example2', 122]
  List<dynamic> ertret4 = ['String example2', 122];
  const ertret5 = ExampleConstComputableInvokationParam();

  jack.methodOne4(10.3);

  jack.methodOne2(ertret5); // valid - blue underscore
  jack.methodOne2(ertret4); // valid - blue underscore
  jack.methodOne2(ertret3); // valid - blue underscore
  jack.methodOne2(ertret3, 10, 20.5, 30); // valid - blue underscore
  jack.methodOne2(ertret, 10, 20.5, 30); // valid - blue underscore
  jack.methodOne2(ertret2); // invalid - red underscore
  jack.methodOne2(const ['abc ${abc2} end', 20]); // invalid - red underscore
  jack.methodOne2([10, 20]); // invalid - red underscore
  ...
  jack.methodOne2(abc2); // invalid - red underscore
  jack.methodOne2('Simple String'); // invalid - red underscore
  jack.methodOne2(
      '''Oh no, String ${abc2} is not allowed'''); // invalid - red underscore
  ...
  jack.methodOne3(oneDollar); // invalid - red underscore
  jack.methodOne3(twoDollar); // invalid - red underscore
