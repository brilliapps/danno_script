        ...
        for (int i = 0; i < iterationExpressions.length; i++) {
          ...
          if (iterationExpressions[i] is Identifier) {
            if (throwOnConditionalLikeOrFunctionOrPossibleIdentifierMultipleAssignmentExpressions) {
              ...
              //    (iterationExpressions[i] as ConditionalExpression)
              //        .elseExpression);
              Identifier expression = iterationExpressions[i] as Identifier;
...
//      UltimateValueType? ultimateValueType
          ...
          case InstanceCreationExpression():
            addLintMessage(
                ...
                msgDebugMode
                    ? errors.ErrorSeverity.ERROR
                    : errors.ErrorSeverity.INFO,
                'getComparableValueFromExpressionOrDartObject() InstanceCreationExpression() found and will be returned');
  ...
  void run(
    ...
    Map<int, List<AssignmentExpression>> assignmentExpressionsByElementId = {};
    Map<int, List<VariableDeclaration>> variableDeclarationsByElementId = {};
    Map<int, Annotation> $AnnotationsByElementId = {};
    ...
    bool? compareValueFromUltimateExpressionWithAnotherUltimateValue({
      ...
      Expression? diagnosticMessageNode,
      ...
      if (value.valueHasBeenFound && value2.valueHasBeenFound
        ...
        if (value.value?.keys.contains(ComparableUltimateValue.simple) ==
                true &&
          ...
          if (expressionF is InstanceCreationExpression &&
            ...
            if (declarationParameterElements != null) {
              for (int i = 0; i < declarationParameterElements.length; i++) {
                ...
                var expressionWithCustomComparisonRequirements =
                    getExpressionWithCustomComparisonRequirements(
                        expressionFCorrespondingParam!,
                        diagnosticMessageNode ?? expression ?? expression2!);
                var expressionWithCustomComparisonRequirements2 =
                    getExpressionWithCustomComparisonRequirements(
                        expressionF2CorrespondingParam2!,
                        diagnosticMessageNode ?? expression ?? expression2!);

                if (expressionWithCustomComparisonRequirements == null ||
                    expressionWithCustomComparisonRequirements2 == null) {
                  addLintMessage(
                      reporter,
                      diagnosticMessageNode ?? expression ?? expression2!,
                      errors.ErrorSeverity.ERROR,
                      'compareValueFromUltimateExpressionWithAnotherUltimateValue() part InstanceCreationExpression() Error: after two calling getExpressionWithCustomComparisonRequirements, one for each expression, at least one of the expression was nullable but had no identifier with nullable type. expressionWithCustomComparisonRequirements == $expressionWithCustomComparisonRequirements, expressionWithCustomComparisonRequirements2 == ${expressionWithCustomComparisonRequirements2} ');
                  return null;
                }
                ...
                bool? comparisonResult =
                    compareValueFromUltimateExpressionWithAnotherUltimateValue(
                  expression:
                      expressionWithCustomComparisonRequirements.expression,
                  dartObjectParam: null,
                  expressionMustBeConst:
                      !expressionWithCustomComparisonRequirements
                          .isMutableValue,
                  expression2:
                      expressionWithCustomComparisonRequirements2.expression,
                  dartObjectParam2: null,
                  diagnosticMessageNode:
                      diagnosticMessageNode ?? expression ?? expression2!,
                  expression2MustBeConst2:
                      !expressionWithCustomComparisonRequirements2
                          .isMutableValue,
                );
                ...
                addLintMessage(
                    ...
                    msgDebugMode
                        ? errors.ErrorSeverity.ERROR
                        : errors.ErrorSeverity.INFO,
                    'compareValueFromUltimateExpressionWithAnotherUltimateValue() part InstanceCreationExpression() comparisonResult = $comparisonResult of expressionFCorrespondingParam = $expressionFCorrespondingParam, expressionF2CorrespondingParam2 = $expressionF2CorrespondingParam2 expressionWithCustomComparisonRequirements == $expressionWithCustomComparisonRequirements, expressionWithCustomComparisonRequirements2 == ${expressionWithCustomComparisonRequirements2} ');
            ...
            for (int i = 0; i < expressionF.elements.length; i++) {
              ...
              bool? comparisonResult =
                ...
                dartObjectParam: null,
                expressionMustBeConst:
                    !expressionWithCustomComparisonRequirements.isMutableValue,
                expression2:
                    expressionWithCustomComparisonRequirements2.expression,
                dartObjectParam2: null,
                diagnosticMessageNode:
                    diagnosticMessageNode ?? expression ?? expression2!,
                expression2MustBeConst2:
                    !expressionWithCustomComparisonRequirements2.isMutableValue,
              );
              ...
              addLintMessage(
                  ...
                  msgDebugMode
                      ? errors.ErrorSeverity.ERROR
                      : errors.ErrorSeverity.INFO,
                  'compareValueFromUltimateExpressionWithAnotherUltimateValue() part InstanceCreationExpression() comparisonResult = $comparisonResult of expressionWithCustomComparisonRequirements.expression = ${expressionWithCustomComparisonRequirements.expression}, expressionWithCustomComparisonRequirements2.expression = ${expressionWithCustomComparisonRequirements2.expression}');
            ...
            addLintMessage(
                ...
                msgDebugMode
                    ? errors.ErrorSeverity.ERROR
                    : errors.ErrorSeverity.INFO,
                '''compareValueFromUltimateExpressionWithAnotherUltimateValue() part ListLiteral() at least one ListLiteral expression is not const. Some const info: expressionF.isConst = ${expressionF.isConst} expressionF2.isConst = ${expressionF2.isConst} expressionF.inConstantContext == ${expressionF.inConstantContext} expressionF.inConstantContext == ${expressionF2.inConstantContext}''');
            if (expressionF.elements.length != expressionF2.elements.length) {
              addLintMessage(
                  reporter,
                  diagnosticMessageNode ?? expression ?? expression2!,
            ...
            for (int i = 0; i < expressionF.elements.length; i++) {
              ...
              addLintMessage(
                  ...
                  msgDebugMode
                      ? errors.ErrorSeverity.ERROR
                      : errors.ErrorSeverity.INFO,
                  'compareValueFromUltimateExpressionWithAnotherUltimateValue() part ListLiteral() comparisonResult = $comparisonResult of expressionWithCustomComparisonRequirements.expression = ${expressionWithCustomComparisonRequirements.expression}, expressionWithCustomComparisonRequirements2.expression = ${expressionWithCustomComparisonRequirements2.expression}, expressionWithCustomComparisonRequirements == $expressionWithCustomComparisonRequirements, expressionWithCustomComparisonRequirements2 == ${expressionWithCustomComparisonRequirements2} ');
            ...
            for (int i = 0; i < expressionF.fields.length; i++) {
              ...
              var expressionWithCustomComparisonRequirements =
                  getExpressionWithCustomComparisonRequirements(
                      expressionF.fields[i] as Expression,
                      diagnosticMessageNode ?? expression ?? expression2!);
              var expressionWithCustomComparisonRequirements2 =
                  getExpressionWithCustomComparisonRequirements(
                      expressionF2.fields[i] as Expression,
                      diagnosticMessageNode ?? expression ?? expression2!);
              ...
              addLintMessage(
                  ...
                  msgDebugMode
                      ? errors.ErrorSeverity.ERROR
                      : errors.ErrorSeverity.INFO,
                  'compareValueFromUltimateExpressionWithAnotherUltimateValue() part RecordLiteral() comparisonResult = $comparisonResult of expressionWithCustomComparisonRequirements.expression = ${expressionWithCustomComparisonRequirements.expression}, expressionWithCustomComparisonRequirements2.expression = ${expressionWithCustomComparisonRequirements2.expression} expressionWithCustomComparisonRequirements == ${expressionWithCustomComparisonRequirements} expressionWithCustomComparisonRequirements2 == ${expressionWithCustomComparisonRequirements2}');
    ...
    checkingReturnTypesAndValues(
        MethodDeclaration methodDeclaration, List<Expression> expressions) {
      addLintMessage(
          reporter,
          methodDeclaration,
          msgDebugMode ? errors.ErrorSeverity.ERROR : errors.ErrorSeverity.INFO,
        ...
        try {
          ...
          if (metad != null &&
            ...
            if (is$ != null && is$) {
              ...
              // FIXME: NOT USED PROBABLY NO LONGER NEEDED
              bool canBeNull = false;
              // FIXME: NOT USED PROBABLY NO LONGER NEEDED
              bool cannotBeNull = false;
              // FIXME: NOT USED PROBABLY NO LONGER NEEDED
              bool hasConditionSwitchedTo$NOTPrior = false;
              for (int i = 1; i <= standardNumberOfFields; i++) {
                ...
                //        ? errors.ErrorSeverity.ERROR
                //        : errors.ErrorSeverity.INFO,
                //    'checkingReturnTypesAndValues: Entered stage #6');
                //addLintMessage(
                //    reporter,
                //    expression,
                //    msgDebugMode
                ...
                if (currentField!.isNull) {
                  ...
                  if (currentField.toTypeValue()!.getDisplayString() ==
                      '\$NOT') {
                    // FIXME: NOT USED PROBABLY NO LONGER NEEDED
                    hasConditionSwitchedTo$NOTPrior = true;
                  } else if (currentField.toTypeValue()!.getDisplayString() ==
                      "Null") {
                    if (!hasConditionSwitchedTo$NOTPrior) {
                      // FIXME: NOT USED PROBABLY NO LONGER NEEDED
                      canBeNull = true;
                    } else {
                      // FIXME: NOT USED PROBABLY NO LONGER NEEDED
              ...
              for (int i = 1; i <= standardNumberOfFields; i++) {
                currentField = computedMetaObject.getField('t$i');
                Expression? currentFieldExpression = methodDeclaration
                ...
                if (currentField!.isNull) {
                  ...
                  if (isNullableValue || hasConditionSwitchedTo$Nullable) {
                    if (currentFieldExpression is! Identifier) {
                      addLintMessage(
                          reporter,
                          methodDeclaration,
                          errors.ErrorSeverity.ERROR,
                          'checkingReturnTypesAndValues() Error: Current expression was in the \$N(expression) so it must be Identifier() instance (int? abc = 10 - abc is Identifier() instance) with declared type that is nullable f.e. int? not int, List? not List');
                    } else {
                      addLintMessage(
                          reporter,
                          methodDeclaration,
                          msgDebugMode
                              ? errors.ErrorSeverity.ERROR
                              : errors.ErrorSeverity.INFO,
                          'checkingReturnTypesAndValues: isNullableValue == true hence Some data: (currentFieldExpression as Identifier).staticType?.nullabilitySuffix == ${(currentFieldExpression as Identifier).staticType?.nullabilitySuffix} currentFieldExpression.staticType == ${currentFieldExpression?.staticType}');
                      // FIXME: i expect this to contain info about nullabilitySuffix
                      // if not you have to go to the declaration variable and get info about the type - left hand or writeElement dont remember now
                      if ((currentFieldExpression as Identifier)
                              .staticType
                              ?.nullabilitySuffix !=
                          NullabilitySuffix.question) {
                        addLintMessage(
                            ...
                            methodDeclaration,
                            errors.ErrorSeverity.ERROR,
                            'checkingReturnTypesAndValues() Error: Current expression was in the \$N(expression) and is Identifier() instance but it was not defined with a nullable type (int? abc = 10 - abc is Identifier() instance) with declared type that is nullable f.e. int? not int, List? not List. WARNING! Read doc // info above the place this message was defined, info on how to get the nullability info in different way if this was incorrect');
                      } else {}
                    }
                  }
                    ...
                    if (comparisonResult == null &&
                      ...
                      comparisonResult2 =
                          compareValueFromUltimateExpressionWithAnotherUltimateValue(
                              ...
                              expressionMustBeConst: !(isMutableValue ||
                                  hasConditionSwitchedTo$Mutable),
                              expression2: methodDeclaration
                                      .metadata[
                                          methodDeclaration.metadata.length - 1]
                                      .arguments
                                      ?.arguments[
                                  i -
                                      1] // to remind you in the previous method call getField was used but it failed so we use this corresponding expression
                              ,
                              expression2MustBeConst2:
                  ...
                  addLintMessage(
                      ...
                      msgDebugMode
                          ? errors.ErrorSeverity.ERROR
                          : errors.ErrorSeverity.INFO,
                      'checkingReturnTypesAndValues() INFO WHAT WE HAVE` expressions compared: $expression, $currentField. comparisonResult = ${comparisonResult}, comparisonResult2 = ${comparisonResult2}, wasUsedComparisonResult2 = $wasUsedComparisonResult2');
                  addLintMessage(
                      reporter,
                      messageNode,
                      msgDebugMode
    ...
    //context.registry.addAnnotation((Annotation annotation) {
    //  addLintMessage(
    //      reporter,
    //      annotation,
    //      msgDebugMode ? errors.ErrorSeverity.ERROR : errors.ErrorSeverity.INFO,
    //      'annotation: ${annotation.name.name} annotation.arguments.length = ${annotation.arguments?.length} annotation.beginToken = ${annotation.beginToken} annotation.beginToken.charOffset = ${annotation.beginToken.charOffset} annotation.atSign = ${annotation.atSign} annotation.atSign.charOffset = ${annotation.atSign.charOffset} annotation.elementAnnotation?.element?.id = ${annotation.elementAnnotation?.element?.id} annotation.elementAnnotation?.element?.name == ${annotation.elementAnnotation?.element?.name}');
    //  if (annotation.elementAnnotation?.element?.id != null
    //      //&& annotation.elementAnnotation!.element!.name == '\$'
    //      ) {
    //    $AnnotationsByElementId[annotation.elementAnnotation!.element!.id] =
    //        annotation;
    //  }
    //  if (annotation.arguments != null) {
    //    for (int i = 0; i < annotation.arguments!.length; i++) {
    //      String msg =
    //          'annotation argument: annotation.arguments?.arguments[i] == ${annotation.arguments?.arguments[i]} annotation.arguments?.arguments[i].unParenthesized = ${annotation.arguments?.arguments[i].unParenthesized}';
    //      addLintMessage(
    //          reporter,
    //          annotation.arguments?.arguments[i],
    //          msgDebugMode
    //              ? errors.ErrorSeverity.ERROR
    //              : errors.ErrorSeverity.INFO,
    //          msg);
    //      addLintMessage(reporter, annotation, errors.ErrorSeverity.INFO, msg);
    //    }
    //  }
    //});
    ...
    handlingFunctionExpressionForFunctionBlockBodyReturnStatement(
      ...
      addLintMessage(reporter, functionExpression, errors.ErrorSeverity.WARNING,
          'handlingFunctionExpressionForFunctionBlockBodyReturnStatement: wasThereAnyEmptyReturnStatement = $wasThereAnyEmptyReturnStatement, wasThereAnyEmptyFunctionBody = $wasThereAnyEmptyFunctionBody, expressions.length ${expressions.length}, expressions: ${expressions}');
      return;
    }
    ...
    context.addPostRunCallback(() {
      ...
      for (dynamic declaration
        ...
        try {
          ...
          addLintMessage(reporter, declaration, errors.ErrorSeverity.ERROR,
              'getUltimateNonConditionalNorSwitchExpressions() context.addPostRunCallback(), handlingFunctionLikeDeclaration(declaration) Error: $e, $stackTrace');
        }
      }
    });
  }
