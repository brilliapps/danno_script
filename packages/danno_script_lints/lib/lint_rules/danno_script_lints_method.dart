...
class DannoScriptLintsMethod extends DartLintRule {
  DannoScriptLintsMethod() : super(code: _code);
    ...
    bool testForIf2Part(
      ...
      for (int p = 1; p <= standardNumberOfFields; p++) {
        ...
        if (currentFieldOf$IF2.isNull) {
          ...
          addLintMessage(messageNode, errors.ErrorSeverity.ERROR,
    ...
    context.registry.addMethodInvocation((MethodInvocation inv) {
      ...
      for (int k = 0; k < prms.length; k++) {
        ...
        try {
                          ...
                          if (currentFieldOf$IF!.type.toString() != "Type") {
                            ...
                            if (hasAnySubIfConditionAppeared2 &&
                              ...
                              addLintMessage(
                                  ...
                                  'Error because hasAnySubIfConditionAppeared2 && !is\$IF2 && !is\$THEN2');
                              return;
                            }
                            ...
                            if (dartType == null) {
                              addLintMessage(
                                  messageNode,
                                  errors.ErrorSeverity.ERROR,
                                  'Diagnostic message, error: assuming that the element MUST be not null but DartType"}');
                              exitTheWhileLoop = true;
                              break;
                            }
          ...
          addLintMessage(messageNode, errors.ErrorSeverity.INFO,
